...
function DataReference() {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-2 pt-2">
        <Link href="/tools/sources" className="text-[10px] text-accent hover:underline flex items-center gap-1">
    ...
    <main className="min-h-screen p-4 sm:p-6 max-w-4xl mx-auto space-y-5">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2">
        {[
          ...
          { href: "/tools/sources", label: "Sources", icon: Database, desc: "All data" },
