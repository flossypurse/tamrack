...
const DATA_SOURCE_MODULES = [
  ...
  { name: "data-sources-aeso.ts", label: "AESO Electricity", endpoints: 3 },
...
const API_ROUTES = [
  ...
  { path: "/api/electricity", label: "AESO Electricity", auth: false },
...
const ENV_KEYS = [
  ...
  { key: "AESO_API_KEY", label: "AESO Electricity", required: false },
