...
export default function EconomyError({ error, reset }: { error: Error; reset: () => void }) {
  return (
    <main className="min-h-screen p-4 sm:p-6 max-w-7xl mx-auto">
      <Card>
        <h2 className="text-sm font-medium text-foreground mb-2">Economy data temporarily unavailable</h2>
        <p className="text-xs text-muted mb-4">
          One or more upstream data sources (Bank of Canada, Statistics Canada) failed to respond.
