  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex gap-2 mt-3">
        ...
        <Link href="/pipeline" className="text-[10px] text-accent hover:underline flex items-center gap-1">
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex gap-2 pt-2">
        ...
        <Link href="/corridors" className="text-[10px] text-accent hover:underline flex items-center gap-1">
          Growth corridors <ChevronRight size={10} />
        </Link>
        <Link href="/micro" className="text-[10px] text-accent hover:underline flex items-center gap-1">
...
export default function DeveloperBriefingPage() {
  ...
  return (
    <main className="min-h-screen p-4 sm:p-6 max-w-4xl mx-auto space-y-5">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2">
        {[
          { href: "/pipeline", label: "Pipeline", icon: Layers, desc: "Dev permits + stages" },
          { href: "/corridors", label: "Corridors", icon: MapPin, desc: "Growth directions" },
          { href: "/micro", label: "Neighbourhoods", icon: Building2, desc: "Micro signals" },
