  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex gap-2 mt-3">
        <Link href="/energy" className="text-[10px] text-accent hover:underline flex items-center gap-1">
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex gap-2 pt-2">
        ...
        <Link href="/drilling" className="text-[10px] text-accent hover:underline flex items-center gap-1">
...
export default function EnergyBriefingPage() {
  ...
  return (
    <main className="min-h-screen p-4 sm:p-6 max-w-4xl mx-auto space-y-5">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2">
        {[
          { href: "/energy", label: "Energy", icon: Flame, desc: "Full dashboard" },
          { href: "/drilling", label: "Drilling", icon: Pickaxe, desc: "Well activity" },
          { href: "/dashboard", label: "Dashboard", icon: BarChart3, desc: "Macro view" },
          { href: "/signals", label: "Signals", icon: Activity, desc: "Indicators" },
        ].map((link) => {
