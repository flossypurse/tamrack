  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex gap-2 pt-2">
        ...
        <Link href="/prospects" className="text-[10px] text-accent hover:underline flex items-center gap-1">
...
export default function RealtorBriefingPage() {
  ...
  return (
    <main className="min-h-screen p-4 sm:p-6 max-w-4xl mx-auto space-y-5">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-2">
        {[
          { href: "/micro", label: "Neighbourhoods", icon: MapPin, desc: "Micro signals" },
          { href: "/signals", label: "Signals", icon: Activity, desc: "Leading indicators" },
          { href: "/real-estate", label: "Market Intel", icon: Home, desc: "Price + volume" },
          { href: "/prospects", label: "Prospects", icon: Target, desc: "Lead lists" },
        ].map((link) => {
